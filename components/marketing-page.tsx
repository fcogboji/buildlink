...
export function MarketingPage({ title, subtitle, children }: MarketingPageProps) {
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-[#fcfbf9] via-[#faf9f7] to-[#f6f4f0] text-stone-900">
      <MarketingHeader />
      <main className="container-app flex-1 py-10 sm:py-12 lg:py-14">
        ...
        <div className="mt-6 max-w-3xl rounded-2xl border border-stone-200/90 bg-white/90 p-6 shadow-sm sm:p-7">
          <div className="space-y-4 text-base leading-relaxed text-stone-700 sm:text-[17px]">{children}</div>
        </div>
      </main>
      <MarketingFooter />
    </div>
